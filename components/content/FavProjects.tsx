  ...
  return (
    ...
    >
      ...
      <div className='flex items-center justify-end gap-3'>
        ...
        <ExternalLink href={repo} customClassName=' inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-900 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
        ...
        <ExternalLink href={link} customClassName=' inline-flex items-center rounded-lg bg-black p-2 hover:bg-gray-900 transition-all ease shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
...
const FavProjects = () => {
  ...
  return (
    <AnimationContainer customClassName='w-full flex flex-col justify-center text-center lg:items-start mb-16'>
      ...
      <h2 className='font-bold text-2xl lg:text-2xl tracking-tight mb-8  text-center lg:text-start'>
